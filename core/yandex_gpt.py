        ...
        if images:
            if tz_text and len(tz_text.strip()) > 20:
                user_msg = (
                    ...
                    "ОБЯЗАТЕЛЬНО включи силовой/вводной выключатель (вакуумный, ВВ, КЭПС, ВБ, VF, NV) — "
                    "это самая дорогая позиция, её нельзя пропускать; а также разъединители и трансформаторы.\n"
